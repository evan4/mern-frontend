        ...
        <section className={landingPageStyles.heroSection}>
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>Create job-winning resumes with expertly designed template.
                ATS-friendly, recruter-approved, and tailored to your carrier goals,</p>
              <div className={landingPageStyles.ctaButtons}>
                ...
                <button className={landingPageStyles.secondaryButton}
                  onClick={handleCTA}>View templates
                </button>
              </div>
              {/*Stats grid */}
